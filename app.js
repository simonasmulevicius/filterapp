...
app.get('/filterapp', (req, res, next) => {
    res.render('filterapp', { title: 'Filter Clients' });
});
        ...
        fs.rename(oldClientsFilePath, newClientsFilePath, (err) => {
            ...
            fs.rename(oldUnwantedClientsFilePath, newUnwantedClientsFilePath, (err) => {
                ...
                fs.writeFile(filePath, buffer, 'utf8', function(err) {
                    ...
                    // We could pass file path and name via response but it might be dangerous!
                    // Hence, temporarely we will use global variables!
                    globalFilePath = filePath;
                    globalFileName = fileName;

                    res.render('filterapp-summary', {
...
app.post('/filterapp-download', (req, res, next) => {
    res.download(globalFilePath, globalFileName);
});
